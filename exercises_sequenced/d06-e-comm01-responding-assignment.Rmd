...
-   Is the bolded response **active** or **passive**? Why?
    -   Active because they respond to the substance of the colleague's question.
-   Is the bolded response **constructive** or **destructive**? Why?
    -   Constructive because they said "good catch" and positively reinforced feedback.
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
    -   More comfortable, more willing to speak if I'm in the colleague's shoes.
...
-   Is the bolded response **active** or **passive**? Why?
    -   Passive. The presenter doesn't address the problem that the colleague is having with their presentation and instead moves on.
-   Is the bolded response **constructive** or **destructive**? Why?
    -   Constructive. The presenter says "good catch there" and positively reinforces feedback.
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
    -   Better because the presenter acknowledged that they were wrong, but didn't try to explain and help their audience understand.
...
-   Is the bolded response **active** or **passive**? Why?
    -   Passive, because the colleague is not interacting with the presenter's content at all.
-   Is the bolded response **constructive** or **destructive**? Why?
    -   Destructive, because the colleague derails the presenter's presentation.
