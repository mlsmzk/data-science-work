...
**Observations**: - Ideal is indeed the most numerous cut of diamonds,
and not the least. Thus hypothesis 1 was incorrect.
...
**Observations**: - It seems hypothesis 2 is also false, because
diamonds of other qualities can be equally as expensive. This means
there is probably another variable (or more) that influence(s) the price
of diamonds more than cut does. This graph is a decent visualization of
data because we would have been able to notice a pattern were there one,
however a box plot would have been better.
...
**Observations**: - This plot demonstrates that there are a lot more
ideal cuts that are expensive than there are that are cheap. This is
because the median line is close to the bottom of interquartile range
box. This does not mean that they are the most expensive. We also see in
the graph that the highest median price is actual for premium cut
diamonds, meaning premium diamonds are on average more expensive in this
dataset.
...
**Observations**: - The highest carat diamonds are of fair cut, meaning
the hypothesis could that carat is favored over cut could explain what
is happening. On the other hand, diamonds of good quality do not tend to
have higher carat value, which one would expect of carat were 100%
favored over cut, but this could be explained by poorer craftsmanship
rather than intention. I would expect to see a negative correlation of
some sort between the two variables.

It does, however, seem that diamonds that are cut to be ideal lose out
in carat to almost every other cut.
