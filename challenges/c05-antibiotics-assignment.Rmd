...
df_antibiotics %>%
  ...
  geom_point(mapping = aes(x = bacteria, y = penicillin), color = "blue") +
  geom_point(mapping = aes(x = bacteria, y = streptomycin), color = "red") +
  geom_point(mapping = aes(x = bacteria, y = neomycin), color = "yellow") +
