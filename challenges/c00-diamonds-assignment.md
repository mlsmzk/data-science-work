...
- There is a positive quadratic correlation between the carat of
  diamonds and their market price in for the diamonds in this dataset.
- There is no diamond below 1 carat that is more expensive than
  \$10,000. However, after diamonds in the dataset exceed 1 carat, they
  can list for around \$20,000.
- The vast majority of diamonds in the dataset have carat value that
  does not exceed 3. The diamonds exceeding 3 carats sell for at least
  \$5,000.
...
- There is a correlation between cut and price. Diamonds of ideal or
  premium cut from this dataset will most often be priced more highly
  than diamonds of similar carat value.
- The price seems to increase quadratically with respect to carat when
  the cut is premium or ideal, but borders on linear when the cut
  quality gets to be fair or good for the diamonds in this dataset.
